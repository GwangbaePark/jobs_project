...
public class JpaBaseConfiguration__TestContext001_BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.entity.infrastructure.jobs.Application", "com.entity.infrastructure.jobs.Company", "com.entity.infrastructure.jobs.JobDescription", "com.entity.infrastructure.jobs.JobSeeker");
